...
function Home() {
    ...
    const [login, setLogin] = useState(''); // hook = gancho
    ...
    const authentication = async (e)=>{
        ...
        if (login != "" && password != "") {
            ...
            const add = await fetch('htt:localhost:3001/login', {
                method: 'POST',
                headers: {
            ...
            if (content.tonken) {
                sessionStorage.setItem("token", content.tonken);
                router.push('/home');
            } else {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__02cca465._.js.map